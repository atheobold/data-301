...
::: {.small}
I'm going to do my best to ensure **all** the skills necessary to complete the 
lab activities are covered during lecture.
...
plot = (
  ggplot(data = titanic, mapping = aes(x = "Pclass", fill = "Sex")) + 
  geom_bar(position = "fill") + 
  theme_bw()
)
