...
Let's take 5-minutes and form groups with other students in the class!
...
Did you find a group to work with? Please fill out this form!

Do you still need to find a group to work with? Please fill out this form!

::: {.centered}
<iframe src="https://forms.gle/gyEAisg2cavhLaW7A" width="640" height="600" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
:::
...
You have the opportunity to earn back up to **75%** of the points you lost. 

::: {.midi}
Revisions must include reflections addressing:

- what aspects of your previous answer were incorrect / misleading / incomplete
- what you changed about your answer to remedy this issue
- what you learned during this process 

::: {.callout-important}
# Revisions are about learning

As such, your reflections should tell me (briefly) what you learned. **Quality** 
of reflection is better than quantity. 
:::
:::

## Revision Submissions - Due Monday, February 23 at 5pm

::: {.midi}
- Revisions should be done in a new (clean) [Colab Notebook](https://colab.research.google.com/drive/1kyLC8i5uJTYjc__V02YAJaNp6ClbuROG?usp=sharing)
  * Reflections should come at the **beginning** of each problem

- Your revisions will be submitted to the **same** assignment portal

- To be eligible for regrading, your revisions must be:
  * Submitted as a PDF (with a Colab link)
  * Printed to landscape
  * Have all your code visible
  * Reflections for every problem being revised
:::
...
In Statistics, we use $\beta_0$ to represent the **population** intercept and
$\beta_1$ to represent the slope. By "population" we mean the true slope of the
line for the entire population of interest.
:::
...
::: {.midi}
The metrics from `sklearn` will **always** want to be *maximized*.
...
[**How many different models were fit with this grid?**]{.large}
...
3.  Which value of $k$ should we use? (**Parameter tuning**)
:::
