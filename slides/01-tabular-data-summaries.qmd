...
reticulate::import("palmerpenguins")
reticulate::import("plotnine")
...
-   The variable `Pclass` is **categorical**, but Python assumed it was 
*quantitative* because it is comprised of numbers.
