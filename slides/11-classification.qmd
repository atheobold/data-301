...
::: {.centered}
![](images/11-breast-diagram.jpeg){width=".4\\textwidth" fig-alt=""}
:::
...
(
  ggplot(data = breast_df, 
         mapping = aes(x = "I0", y = "PA500", fill = "Class")) +
  geom_point(size = 2) +
  theme_bw() +
...
::: {.callout-caution}
# What is this transformer doing?
:::
...
pd.DataFrame(confusion_matrix(y_train, y_train_), 
             columns = pipeline.classes_, 
             index = pipeline.classes_)
```
